...
public class YamlLoader implements Loader {
    ...
    private static String read(InputStream input) throws IOException {
        ...
        // authenticates nowhere, and nothing anywhere saying why. the YAML specification says the document
        ...
        try {
            ...
            throw new IOException("the document is not valid UTF-8, which YAML requires: "
