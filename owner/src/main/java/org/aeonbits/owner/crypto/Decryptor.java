 ...
 * <p>
 * This interface allows separation between the API needed by OWNER at decryption level and an implementation backed by
 * a decryption library, such as javax.crypto or others.
 */
public interface Decryptor extends Serializable {
     ...
     * @param value the value to decrypt.
     * @param defaultValue the value to return in case a failure occurs.
