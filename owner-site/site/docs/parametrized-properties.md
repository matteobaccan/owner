...
<div class="note">
  ...
  <p>
    ...
    <a href="{{ site.url }}/docs/variables-expansion/">variables expansion</a> is performed on it, and the
...
<div class="note info">
  ...
  <p>
    ...
    <code>VARIABLE_EXPANSION</code> (see <a href="{{ site.url }}/docs/disabling-features/">Disabling features</a>)
