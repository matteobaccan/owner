...
Preprocessing happens on the raw property value, *before* [variables expansion]({{ site.url }}/docs/variables-expansion/),
[decryption]({{ site.url }}/docs/crypto/), [parametrized formatting]({{ site.url }}/docs/parametrized-properties/) and
[type conversion]({{ site.url }}/docs/type-conversion/): whatever your preprocessors return is what the rest of the
pipeline will see.
...
<div class="note">
  ...
  <p>
    ...
    <code>null</code> as explained in <a href="{{ site.url }}/docs/usage/">Basic usage</a>.
  </p>
</div>
