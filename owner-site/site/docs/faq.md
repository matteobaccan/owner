...
See: [Undefined properties]({{ site.url }}/docs/usage/#undefined-properties) in [Basic usage]({{ site.url }}/docs/usage/) chapter.
If a property is required and has no sensible default, you can annotate it with `@Mandatory` to fail fast with a
meaningful exception: see [Mandatory properties]({{ site.url }}/docs/usage/#mandatory-properties).
