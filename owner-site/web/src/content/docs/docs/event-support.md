...
As explained in [Reload and Hot Reload](/owner/docs/reload/) section, OWNER supports programmatic reload and
...
![reload-event](/owner/img/reload-event.png)
...
interface, or when a [reload](/owner/docs/reload/) happens.
...
![propertychange-event](/owner/img/propertychange-event.png)
